...
const Login = () => {
  ...
  return (
    ...
    <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
      <h2 className='text-3xl font-semibold text-white text-center mb-3'>{state==='Sign Up'?'Create your acoount':'Login to your account!'}</h2>
      ...
      <form onSubmit={onSubmitHandler}>
        ...
        <button className='w-full py-2.5 rounded-full bg-gradient-to-r from-indigo-500 to-indigo-400 text-white font-medium'>{state}</button>
      </form>
      {state==='Sign Up' ?
